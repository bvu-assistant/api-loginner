...
async function getLiability(url, ssid)
{
    try
    {
        ...
        let stream = await new Promise((resolve, reject) =>
        {
            ...
            (
                ...
                (err, res, body) =>
                {
                    ...
                    theLiability = $('td[colspan=10] >p >span:last-child').first().text();
                            
                    console.log(theLiability);
                    ...
                    return resolve(response.Term === ''? 'null': response);
                }
            );
        });
